...
const ProviderCarousel = () => {
  const slides = [
    {
      title1: "Join Teledental as a Dentist",
      title2: "Become a Virtual Provider",
      keywords: [
        "Expand your reach",
        "Grow your practice",
      ...
      content: [
        "Join the Teledental.com Team!",
        "As a Teledental Dentist.",
        "Let us help market your dental practice.",
      ],
      cta: "Register as Dentist",
    },
    {
      title1: "Add Teledental to Your Practice",
      subtitle: "Grow your dental practice by offering virtual consultations.",
      cta: "Register as Dentist",
    },
  ];
