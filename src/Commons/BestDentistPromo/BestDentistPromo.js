...
import logo from "../../assets/img/TeleDental-web.webp";
      ...
      <div id="main-wrapper">
        <div className="header">
          <div className="main-heading">
            Teledental | DentalChat | <br />
            New Leads | SEO and
            <br /> more
          </div>
          <div className="secondary-heading">
            <span className="secondary-text">
              <strong>#1 Dental Ecosystem that no other can match</strong>
            </span>
            <div>
              <span className="secondary-text">
            ...
            <span className="secondary-text">
              <strong>With the best low prices in one place</strong>
            </span>
          </div>
        </div>
        <div className="middle-section">
          <Row>
            <p className="middle-section-heading">
              Easy as 1-2-3 and much more
            </p>
            <Col xs={12} md={4}>
              <ol>
            ...
            <Col>
              <Link to="/" className="n_signup_logo">
                <img width={300} src={logo} alt="TeleDental" />
              </Link>
            </Col>
          </Row>
          <Row>
            ...
            <span className="sitemap">
              Teledental.com {">"} Dentalchat.com {">"} DentistList.com {">"}{" "}
              MapDentist.com {">"} and many others
            </span>
            <Col>
              <ul>
          ...
          <Row className="mt-2">
            <Col xs={12} md={4} className="mb-3">
              <div className="package-card">
                ...
                <div>
                  <span className="package-price">$549</span>mo
                </div>
                <p>$499 / 6 months</p>
                <p>
                  <strong> $388 / yearly </strong>
                </p>
              </div>
            </Col>
            <Col xs={12} md={4} className="mb-3">
              <div className="package-card premium">
                ...
                <div>
                  <span className="package-price">$1799</span>mo
                </div>
                <p>$1699 / 6 months</p>
                <p>
                  <strong> $1488 / yearly </strong>
                </p>
              </div>
            </Col>
            <Col xs={12} md={4} className="mb-3">
              <div className="package-card">
                ...
                <div>
                  <span className="package-price">$2199</span>mo
                </div>
                <p>$1999 / 6 months</p>
                <p>
                  <strong> $1788 / yearly </strong>
                </p>
              </div>
            </Col>
          </Row>
        ...
        <div className="contact">
          <span>
            <strong>Contact us at:</strong>&nbsp; service@teledental.com or
            service@dentalchat.com
          </span>
        </div>
      </div>
    </div>
