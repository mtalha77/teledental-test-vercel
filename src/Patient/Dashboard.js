...
import HappyFace from "../assets/img/happy.webp";
    ...
    <>
      ...
      >
        <div className="d-flex align-items-center justify-content-between mt-2">
          ...
          <Button
            className="brix---btn-primary w-button btn-edit prim_btn_blue-outlined mb-2 h-auto fs-6"
        ...
        <Row className={`${classes.cardCtn} flex-sm-row dashboard-cards`}>
          <Col span={4} className={`analyticsDash create-request-card`}>
            <Card
            ...
            >
              <div style={{ fontWeight: 500 }}>
                ...
                <p style={{ color: "#0071bc", cursor: "pointer" }}>
                  <u>Click here</u>
                </p>
              </div>
            </Card>
