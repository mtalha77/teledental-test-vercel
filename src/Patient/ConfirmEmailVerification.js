...
import logo from "../assets/img/NewLogo.f770c6ff.webp";
...
const ConfirmEmailVerification = () => {
  ...
  useEffect(() => {
    ...
    let mounted = true;
    confirmVerifiedAccount(email).then((items) => {
      if (mounted) {
      }
    });
      ...
      <Card>
        <>
          <div className="parent-container">
            ...
            <div className="visit">Teledental.com</div>
            <div className="thanks">
              <p>Thanks,</p>
              <span className="team">Team</span>
              <span class="teledental">Teledental</span>
            </div>
