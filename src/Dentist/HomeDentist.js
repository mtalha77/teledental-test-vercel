  ...
  return (
    <>
      ...
      <div className="custom-home-dentist-bg-primary text-white py-5">
        <div className="container">
          <div className="row">
            <div className="col-lg-4 col-md-12 mb-md-4 mb-lg-0">
              <div className="d-flex flex-column align-items-lg-start align-items-center">
                ...
                <button className="start-here-text btn bg-white fw-bold mt-4 px-4 py-2 rounded-pill">
                  Start Here / Register
                </button>
              </div>
            </div>
              ...
              >
                ...
                >
                  <div className="step-content text-center">
                    ...
                    <h4 className="custom-home-dentist-primary-text-color fw-bold mb-2">
                      Register as Dentist
                    </h4>
